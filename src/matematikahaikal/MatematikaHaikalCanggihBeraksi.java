...
public class MatematikaHaikalCanggihBeraksi {
    public static void main(String[] args) {
        // Membuat objek dari kelas MatematikaFahmi
        MatematikaHaikal mtk = new MatematikaHaikal();
        ...
        MatematikaHaikalCanggih mtkCanggih = new MatematikaHaikalCanggih();
